...
class RatingServiceImplTest {
    ...
    void getRating_shouldThrowNotFoundException() {
        doReturn(Optional.empty())
                ...
                .findByPassengerId(TestData.PASSENGER_ID);

        assertThrows(RatingNotFoundException.class,
                () -> ratingService.getRating(TestData.PASSENGER_ID));

        verify(ratingRepository).findByPassengerId(eq(TestData.PASSENGER_ID));
    }
    ...
    void getRating_shouldReturnExpectedResponse() {
        ...
        RatingResponse actual = ratingService.getRating(TestData.PASSENGER_ID);
    ...
    void addScore_shouldReturnExpected(int newScore) {
        ...
        RatingResponse actual = ratingService.addScore(TestData.PASSENGER_ID, newScore);
    ...
    void addScore_shouldThrowRatingNotFoundException() {
        ...
        assertThrows(RatingNotFoundException.class,
                () -> ratingService.addScore(TestData.PASSENGER_ID, 5));
